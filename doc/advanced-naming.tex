...
{\ttfamily \$(),.:\textbackslash} expunged by default.

\begin{tcblisting}{kodi snippet}
\SmashAndCenter{\begin{kodi}\pgfkeys{/kD/diagrams/golden}
\obj{ |[replace character=F with G]| \lim F &
      |[remove character=F]|         \lim F \\
      |[replace charcode=92 with /]| \lim F &
      |[remove charcode=32]|         \lim F \\ };
