...
\begin{marginfigure}[0cm]
  \begin{subfigure}{\marginparwidth}
    \begin{tikzpicture}[kodi, tetragonal=base {0.2\marginparwidth} height {0.2*1.618\marginparwidth}]
      % drawing area
  ...
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[kodi, hexagonal=horizontal side {0.4*\marginparwidth} angle 60]
      % drawing area
      \clip (-2.5,-2.5) rectangle (2.5,2.5);
      % checkers and dots
  ...
  \end{subfigure}
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[kodi, hexagonal=vertical side {0.2*\marginparwidth*2/sqrt(3)} angle 60]
      % drawing area
      \clip (-2.5,-2.5) rectangle (2.5,2.5);
      % checkers and dots
