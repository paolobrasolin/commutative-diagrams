...
\begin{marginfigure}[0cm]
  \begin{subfigure}{\marginparwidth}
    \begin{tikzpicture}[kodi, rectangular={0.2\marginparwidth}{0.2*1.618\marginparwidth}]
      % drawing area
  ...
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[kodi, comb=horizontal step {0.4*\marginparwidth} angle 60]
      % drawing area
      \clip (-2.5,-2.5) rectangle (2.5,2.5);
      % checkers and dots
      ...
      \draw [measure, decoration=mirror, yshift=-3pt]
        (0,0) -- (2,0)
        node [label style, midway, below, yshift=-3pt] {step};
      % angle marker
      \draw (0.66*1.7cm, 0)
        arc (0:30:0.66*1.7cm)
  ...
  \end{subfigure}
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[kodi, comb=vertical step {0.2*\marginparwidth*2/sqrt(3)} angle 60]
      % drawing area
      \clip (-2.5,-2.5) rectangle (2.5,2.5);
      % checkers and dots
      ...
      \draw [measure=0.3, xshift=-3pt]
        (0,0) -- (0,2) node [label style, pos=0.3, left, xshift=-3pt]  {step};
      % angle marker
      \draw 
