...
\newpage
\section{Advanced: shortcuts}
\input{advanced-shortcuts}
\newpage
\section{Advanced: naming}
\input{advanced-naming}
\newpage
\section{Naming: expansion}
\input{naming-expansion}
\newpage
\section{Naming: replacement}
\input{naming-replacement}
\newpage
\section{Naming: overwriting}
\input{naming-overwriting}
\newpage
\section{Gallery}
\input{gallery}
