...
\marginpar{\begin{SmashAndCenter}\begin{kodi}[comb=horizontal step 3.2em angle 60]
  \clip (-2.5,-2.5) rectangle (3.5,2.5);
  ...
  \coordinate (O) at (0,0);
  \node
    [above left=of O, inner sep=0sp, outer sep=0sp, anchor=center]
    [pin={[pin edge={thin, black}, label, outer sep=.2em, font={\ttfamily\tiny}]60:{above left=of O}}]
    {};
