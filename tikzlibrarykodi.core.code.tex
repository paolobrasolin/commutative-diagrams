...
\bgroup
\catcode`&=\active
\gdef\monk@nil{\thisshouldnthappen monk nil unique expansion text}
...
\gdef\matrix@ofnodekeys@start@cell@@#1&{
  \message{XXXXXXXXXXXXX\tikzmatrixname}
  \node [/kD/parse/object={#1}, /kD/render/object,
...
\def\kDDoLatticeWithOptions[#1]%
  {\matrix [matrix of node keys, /kD/parse/lattice={#1}, /kD/render/lattice] }
