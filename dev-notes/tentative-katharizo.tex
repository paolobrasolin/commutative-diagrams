...
% TODO: clean this up when new code is solid
...
% This macro is a convenient shortcut. Inputting literal spaces in code is hard.
\begingroup\catcode`\ =11
\gdef\kDKatharizoBlankSpaceReplacement%
{\pgfkeysvalueof{/katharizo/replace/blank space  }}
\endgroup
...
\def\kDKatharizoSanitizeString#1 #2\kD{%
  ...
  \kDKatharizoBlankSpaceReplacement\fi\fi\fi
  % NOTE: old implementation
