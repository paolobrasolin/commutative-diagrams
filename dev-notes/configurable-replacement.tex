...
\pgfkeys{
  /katharizo/replace/.code args={#1 with #2}{%
...
\pgfkeys{
  /katharizo/replace={ } with {\space},
  /katharizo/replace={$} with {},
  /katharizo/replace={(} with {},
  /katharizo/replace={)} with {},
  /katharizo/replace={,} with {},
  /katharizo/replace={.} with {},
  /katharizo/replace={:} with {},
  /katharizo/replace={_} with {_},
}
...
% \pgfkeys{
%   /katharizo/replace token/.code args={#1 with #2}{%
%     \edef\kDFoo{\string#1}
%     \pgfkeys{/katharizo/replace/toks/\kDFoo/.initial={#2}}
%   },
% }

% \pgfkeys{
%   /katharizo/replace token={\cool} with {X}
% }
...
% \def\PRINT#1#2\STOP{%
% \pgfkeysifdefined{/katharizo/replace/toks/\string#1}%
%   {\pgfkeysvalueof{/katharizo/replace/toks/\string#1}}%
%   {#1}%
% \ifx#2\STOP\else{\PRINT#2\STOP}\fi%
% }

% \expandafter\PRINT\the\TOKS\STOP
