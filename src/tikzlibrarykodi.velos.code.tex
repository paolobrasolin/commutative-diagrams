...
\def\kDVelosFFSBracketsThen#1(#2){\kDVelosSource={#2}\kDVelosCurFstSrc={#2}#1}
 \def\kDVelosFFSTillOverThen#1#2 {\kDVelosSource={#2}\kDVelosCurFstSrc={#2}#1}
...
\def\kDVelosFEEnquotedThen#1"#2"{\kDVelosTempIsKeysListfalse\kDVelosTemp={#2}#1}
\def\kDVelosFEKeysListThen#1[#2]{\kDVelosTempIsKeysListtrue\kDVelosTemp={#2}#1}
\def\kDVelosFETillOverThen#1%
{\kDVelosTempIsKeysListfalse\kDVelosTemp={}\kDVelosFETOThen{#1}}
...
\def\kDVelosFEAppendThen#1#2{\kDVelosTemp=\expandafter{\the\kDVelosTemp#2}#1}
...
\def\kDVelosFTBracketsThen#1(#2){\kDVelosTarget={#2}\kDVelosCurLstTar={#2}#1}
\def\kDVelosFTTillOverThen#1{\kDVelosTarget={}\kDVelosFTTOThen{#1}}

\def\kDVelosFTTOThen#1{
\def\kDVelosFTTOLoop{\kDVelosFTTOThen{#1}}
\def\kDVelosFTTOExit{\kDVelosCurLstTar\expandafter{\the\kDVelosTarget}#1}
\kDIfNextSoftCh\kDBlankSpace
  {\kDVelosFTTOExit}
  {\kDIfNextHardCh;
    {\kDVelosFTTOExit}
...
\edef\Act{\noexpand\path[/velos/every path][
  /tikz/every edge/.append style={\the\kDVelosGlobalEdgeOptions},
  /tikz/every edge quotes/.append style={auto,\the\kDVelosGlobalLabelOptions},
] (\the\kDVelosDerefSrc) edge[\the\kDVelosEdge] (\the\kDVelosDerefTar);}
\Act
#1}
...
% \showthe\kDVelosCurFstSrc
% \showthe\kDVelosCurLstTar
}{
