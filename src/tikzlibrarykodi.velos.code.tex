...
\def\ThinkThen#1{%
  ...
  \def\Break{#1}
  \IfNextChar[{%
      \edef\Act{\noexpand\edg={edge node={node[/kD/every label,\the\glab,\the\tmp]},\the\edg}}\Act
    ...
    \IfNextChar:{
      ...
      \iftmpiskeylist
        \edef\Act{\noexpand\edg={/kD/every arrow,\the\gedg,\the\tmp,\the\edg}}\Act
      \else
        \edef\Act{\noexpand\edg={/kD/every arrow,\the\gedg,\the\tmp,\the\edg}}\Act
      \fi
      \Break
...
\def\mor{\FetchGOptThen{\DoFirstEdgeThen\MaybeChainAnotherEdge}}
