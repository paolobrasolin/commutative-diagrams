...
\def\kDThetoFetchOptions|#1|%
  {\kDThetoTokOpt={#1}\kDThetoTokBuf={}\kDThetoMaybeBog}

\def\kDThetoIdentity#1{#1}

\bgroup\catcode`&=\active
\gdef\kDThetoMaybeBog%
{\kDIfNextChar&{}{\kDIfNextChar\\{}{\kDIfNextChar\kDBlankSpace%
{\kDThetoSpaceIt\expandafter\kDThetoMaybeBog\kDThetoIdentity}{\kDThetoBog}}}}
\egroup
