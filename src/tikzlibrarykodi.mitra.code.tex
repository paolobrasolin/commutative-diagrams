...
\def\kDRTSGob{%
\kDIfNextSoftCh\kD%
{\ifkDRTSPrevSpace\kDRTSHasTrailtrue\else\kDRTSHasTrailfalse\fi\kDGobble}%
{\kDIfNextSoftCh\kDBlankSpace%
{\kDRTSPrevSpacetrue\expandafter\kDRTSGob\kDIdentity}%
{\kDRTSPrevSpacefalse\expandafter\kDRTSGob\kDGobble}%
}%
}
...
\kDIfNextHardCh\\{\global\kDCurrentRowReadyfalse}%
{\kDIfNextHardCh&{&{}}{&}}% fill up incoming empty cells with {}
}

\egroup

\def\kDParseCell%
{\kDIfNextHardCh|{\kDFetchOptions}{\kDFetchOptions||}}
