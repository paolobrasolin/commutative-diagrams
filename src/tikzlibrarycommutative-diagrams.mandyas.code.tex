...
%=[ lattice styles ]============================================================
  /kD/layouts/.cd,
    ...
    %
    square/.style={
      /kD/layouts/tetragonal=base {#1} height {#1},
    },
    golden/.style={
      /kD/layouts/tetragonal=base {#1} height {0.618*#1},
    },
...
%=[ diagram styles ]============================================================
  /kD/diagrams/.cd,
    ...
    %
    hexagonal/.code args={#1side #2 angle #3}{
      \pgfkeys{/kD/diagrams/#1hexagonal=side #2 angle #3}
    },
    horizontal hexagonal/.style args={side #1 angle #2}{
      /kD/every layout/.append style={/kD/layouts/hexagonal=horizontal side {#1} angle {#2}},
      /kD/diagrams/grid={#1*0.5}{#1*tan(#2)*0.5},
      /kD/diagrams/metric={2}{0.5},
    },
    vertical hexagonal/.style args={side #1 angle #2}{
      /kD/every layout/.append style={/kD/layouts/hexagonal=vertical side {#1} angle {#2}},
    ...
    %
    tetragonal/.style args={base #1 height #2}{
      /kD/every layout/.append style={/kD/layouts/tetragonal=base {#1} height {#2}},
    ...
    square/.style={
      ...
      /kD/diagrams/tetragonal=base {#1} height {#1},
    },
    golden/.style={
      /kD/every layout/.append style={/kD/layouts/golden=#1},
      /kD/diagrams/tetragonal=base {#1} height {0.618*#1},
    },
    square/.default=4.5em,
    golden/.default=4.5em,
}
...
\pgfqkeys{/kD}{
  ...
  prompter pinner/.style={
    /tikz/draw=violet,
    /tikz/line width=1sp,
    /tikz/label={[/kD/prompter label]:#1},
  },
  prompter/.style={/bapto/output/.forward to=/kD/prompter pinner}
}
