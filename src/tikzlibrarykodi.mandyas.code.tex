...
%=[ lattice styles ]============================================================
  /kD/layouts/.cd,
    rectangular/.style 2 args={
      ...
      % /kD/every object/.append style={/tikz/node distance=#1 and #2}
    },
    square/.style={
    ...
    comb/.style={% TODO: double check the damn trig
      /kD/layouts/rectangular={#1}{sqrt(3/4)*#1},
      /tikz/every odd row/.append style={/tikz/xshift=1/2*#1}
    },
    comb/.default=4.5em,
...
%=[ diagram styles ]============================================================
  /kD/diagrams/.cd,
    square/.style={
      /kD/every layout/.append style={square={#1}},
      /kD/every object/.append style={/tikz/node distance={#1}}
    },
    square/.default=4.5em,
    golden/.style={
      /kD/every layout/.append style={golden={#1}},
      /kD/every object/.append style={
        /tikz/node distance=0.618*#1 and #1,
        % /tikz/centered,
        /tikz/on grid,
      }
    },
