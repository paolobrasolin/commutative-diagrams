...
%
\begin{tcblisting}{kodi snippet, listing options={linerange=2-2}}
...
%
\begin{tcblisting}{kodi snippet, listing options={linerange=2-5}}
\nilstrut\smash{\tikzpicture[baseline=(current bounding box.center),kodi]
\obj {
  A & B \\
  C & D \\
...
%
\begin{tcblisting}{kodi snippet, listing options={linerange=2-3}}
\nilstrut\smash{\tikzpicture[baseline=(current bounding box.center),kodi]
\obj {\lim F};
...
%
\begin{tcblisting}{kodi snippet, listing options={linerange=2-4}}
\nilstrut\smash{\tikzpicture[baseline=(current bounding box.center),kodi]
\obj { A & B \\ C & D \\ };
\mor A -> B -> D;
\mor * -> C -> *;
